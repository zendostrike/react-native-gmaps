...
public class GMapsView extends MapView implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
  ...
  private final GMapsViewManager manager;
  private final ThemedReactContext context;

  public GMapsView(@NonNull ThemedReactContext context, @Nullable GoogleMapOptions options, GMapsViewManager manager) {
